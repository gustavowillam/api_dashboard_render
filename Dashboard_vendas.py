...
# título
#st.title("Data App - Dashboard de Vendas")
...
if __name__ == '__main__':
    #app.run_server(debug=True, port = 8080)  #para rodar arquivo .py no Spyder 
    #app.run_server(debug=True, port=8080, use_reloader = False)    #para rodar arquivo .ipynb no JupyterNootebook 
